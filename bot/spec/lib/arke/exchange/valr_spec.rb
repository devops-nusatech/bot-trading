...
describe Bot::Exchange::Valr do
  ...
  let(:pair) { Bot::Market.new(market_id, valr) }
  let(:order) { Bot::Order.new("ethusd", 1, 1, :buy) }
  let(:valr) { Bot::Exchange::Valr.new(exchange_config) }
  ...
  context "private endpoints" do
    ...
    context "fetch_openorders" do
      it do
        expect(valr.fetch_openorders("btczar")).to eq(
          [
            Bot::Order.new("BTCZAR", 100_000, 0.1, :sell, "limit", "da99bd40-41a2-42dd-8601-bc99edc31df2"),
          ]
        )
        expect(valr.fetch_openorders("ethzar")).to eq(
          [
            Bot::Order.new("ETHZAR", 150_000, 0.07465, :sell, "limit", "b53f4f12-f156-4623-81fe-98425760d417"),
          ]
        )
      end
    end
    ...
    context "stop_order" do
      ...
      .to_return(
        ...
        valr.stop_order(Bot::Order.new("BTCZAR", 100_000, 0.1, :sell, "limit", "da99bd40-41a2-42dd-8601-bc99edc31df2"))
      end
    end
    ...
    context "create_order" do
      it "creates a limit order" do
        ...
        o = valr.create_order(Bot::Order.new("ETHZAR", 150_000, 0.07465, :sell))
      ...
      it "creates a market order sell" do
        ...
        o = valr.create_order(Bot::Order.new("ETHZAR", 0, 0.07465, :sell, "market"))
        expect(o.id).to eq("558f5e0a-ffd1-46dd-8fae-763d93fa2f25")
      end
      ...
      it "creates a market order buy" do
        ...
        o = valr.create_order(Bot::Order.new("ETHZAR", 150_000, 0.07465, :buy, "market"))
        expect(o.id).to eq("558f5e0a-ffd1-46dd-8fae-763d93fa2f25")
      end
    end
  end
