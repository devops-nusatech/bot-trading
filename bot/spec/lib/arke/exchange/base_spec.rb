...
describe Bot::Exchange::Binance do
  ...
  let(:base) do
    Bot::Exchange::Base.new("driver" => "base")
  end
  ...
  context "notify_private_trade" do
    let(:trade) { Bot::Trade.new("ethusdt", :sell, 0.1, 180.0132, 632_478) }
    let(:incorrect_trade) { Bot::Trade.new("btcusdt", :sell, 0.1, 180.0132, 632_479) }
    let(:order) { Bot::Order.new("ETHUSDT", 2, 1, :buy) }
