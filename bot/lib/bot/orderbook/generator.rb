  ...
  class Generator
    ...
    def shape(a)
      ...
      @levels_count.times do |n|
        order = Bot::Order.new(@market, current_ask_price, a.call(n), :sell)
        ...
        @price_points_asks << ::Bot::PricePoint.new(current_ask_price)
      end

      current_bid_price = @best_bid_price
      @levels_count.times do |n|
        order = Bot::Order.new(@market, current_bid_price, a.call(n), :buy)
        ...
        @price_points_bids << ::Bot::PricePoint.new(current_bid_price)
      end
    end
